...
@app.route('/atualizar-inicio', methods=['POST'])
def atualizar_inicio():
    ...
    try:
        ...
        if novo_inicio and novo_inicio in grafo:
            inicio = novo_inicio
            return jsonify({'mensagem': f'Nó inicial atualizado para {inicio}'}), 200
        else:
            return jsonify({'mensagem': 'Nó inválido'}), 400
